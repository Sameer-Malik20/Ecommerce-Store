...
An elegant and feature-rich e-commerce web application built with React.js, Tailwind CSS, and Node.js. This project enables users to browse products, manage their shopping cart, and complete purchases seamlessly. It also includes an admin panel for managing products and orders.
...
- **Product Browsing:** View products with details, images, and prices.
- **Search & Filter:** Search products and filter by categories.
- **Shopping Cart:** Add, remove, and update products in the cart.
- **Checkout:** Proceed with checkout and order placement.
- **Admin Panel:** Manage products, view orders, and update inventory.
...
5. For admin users, access the admin dashboard to manage products and orders.
