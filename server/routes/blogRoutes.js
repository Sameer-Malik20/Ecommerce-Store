...
import { Create, Delete, getAllBlogs, Update } from "../controller/blogs.js";
...
router.post("/blog/:blogId/review", authMid, addReview);
router.delete("/blog/:blogId/review/:reviewId", authMid, deleteReview);
