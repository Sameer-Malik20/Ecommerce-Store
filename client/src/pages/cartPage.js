      ...
      try {
        ...
        setCartItems(
          res.data.cart.items.map((item) => ({
            ...
            model: item.blog.model || "",
            hsCode: item.blog.hsCode || "",
            quantity: item.quantity,
            weight: item.blog.weight || 1,
            perPieceRate: item.blog.price,
            totalPrice: item.blog.price * item.quantity,
            color: "Black",
            deliveryMethod: "Air",
            ...
            image: item.blog.image || "https://via.placeholder.com/150",
          }))
        );
      } catch (e) {
        setCartItems([]);
